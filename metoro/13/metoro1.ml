...
let koushin1 p q = match (p,q) with
    ...
    { namae = n2; saitan_kyori = s2; temae_list = te2 }) ->
        if hojo_koushin n1 n2 global_ekikan_list = infinity then q
                                                            else if hojo_koushin n1 n2 global_ekikan_list +. s1 < s1 then {namae = n2; saitan_kyori = s1 +. hojo_koushin n1 n2 global_ekikan_list ; temae_list = n2 :: te1} 
                                                                                                                     else q
